        ...
        <ul class="main-navigation__quizy js-main-navigation__quizy">
            ...
            if ($user->getSession() === FALSE) {
                echo"<li class=\"main-navigation__quizy-item\">
                    <a  href=\"login.php\" class=\"main-navigation__link\">
                      Logowanie
                    </a>
                  </li>
                  <li class=\"main-navigation__quizy-item\">
                ...
                if($_SESSION['rola']==="1"){
                    echo "<li class=\"main-navigation__quizy-item\">
                              <a href=\"admin_panel.php\" class=\"main-navigation__link\">
                                  Moje konto
                                </a>
                              </li> ";
                }
                    ...
                    echo "<li class=\"main-navigation__quizy-item\" >
                              <a href=\"user_panel.php\" class=\"main-navigation__link\">
                                  Moje konto
                                </a>
                              </li> ";
                };
...
<div class="container" style ="padding-top: 200px">
     ^^^^^^^^^^^^^^^^^^^^^^^^ tymczasowy styl do zmiany !

    <section class="about-us">
        <div class="about-us__text">
            <h3 class="about-us__header">Ranking</h3>
            ...
            foreach ($infoRanking as $n =>$row) {
                ...
                $position = $n + 1;
                echo "{$position}. {$username} - {$points} punktów na {$max_points}. Celność {$procentUser}<br>";
